...
var panda_lang_q003=panda_zhcn?'公共账号无法加载原图，是否开启嗅探模式？（很慢）':'Public account can not load original image, turn on sniff mode? (Slow)';
