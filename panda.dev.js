...
if(panda_filefinl<1){alert(panda_lang_a004);return;};
...
if(panda_filefrom>panda_fileqnty){alert(panda_lang_a004);return;};
document.getElementById('panda_filefrom').value=panda_filefrom;
document.getElementById('panda_filefinl').value=panda_filefinl;
panda_showlist();
};
