...
else if(document.documentElement.outerHTML.match(/^err/)){if(window.location.pathname=='/fullimg.php'){document.body.innerHTML='<img id="img" src="" alt="Loading..." style="max-width:100%;" />';panda_sniffimg(true,function(){var img=new Image();img.src=window.location.href;img.onerror=function(){panda_recookie();};img.onload=function(){document.getElementById('img').src=img.src;panda_recookie();};});}else{panda_exkeyset();}}
